...
const FooterSimpleFood = () => {
    ...
    return (
        // Mantenemos el padding vertical bajo (py-6)
        <footer className="bg-gray-900 text-gray-400 py-6">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4">
                
                {/* SECCIÓN PRINCIPAL: Título y Logo */}
                <div className="flex flex-col md:flex-row md:justify-between items-center pb-4 border-b border-gray-800">
                    
                    {/* Título/Logo Minimalista (se queda como el punto focal) */}
                    ...
                    {/* ENLACES LEGALES Y CONTACTO (alineados a la derecha en desktop) */}
                ...
                {/* SECCIÓN DE COPYRIGHT (Pequeña y sutil) */}
